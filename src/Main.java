...
public class Main {
  ...
  private static String DEFAULT_WORKING_DIRECTORY_PATH = new File(new File(System.getProperty("user.dir")).getParent(), "cob_spec").toString();
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    Main main = new Main();
    main.io = new SystemIo();
    main.router = new Router();

    main.io.out("Ninja Server Menu");
    main.io.out("----------------------");
    main.io.out("Type \"help\" to see a list of available commands.");

    while (true) {
      String input = main.io.in();

      if (input.startsWith("start")) {
        main.setAndValidateServerConfig(input);
        main.start();
      }
  ...
  private void setAndValidateServerConfig(String serverConfigString) throws IOException {
